...
declare module "@nomicfoundation/hardhat-ethers/types" {
  ...
  getContractFactory(name: 'AuditorStaking', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.AuditorStaking__factory>
...
getContractFactory(name: 'CommitteeGovernance', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.CommitteeGovernance__factory>
...
getContractFactory(name: 'MultisigDisbursement', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.MultisigDisbursement__factory>
  ...
  getContractAt(name: 'AuditorStaking', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.AuditorStaking>
...
getContractAt(name: 'CommitteeGovernance', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.CommitteeGovernance>
...
getContractAt(name: 'MultisigDisbursement', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.MultisigDisbursement>
  ...
  deployContract(name: 'AuditorStaking', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.AuditorStaking>
...
deployContract(name: 'CommitteeGovernance', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.CommitteeGovernance>
...
deployContract(name: 'MultisigDisbursement', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.MultisigDisbursement>
  ...
  deployContract(name: 'AuditorStaking', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.AuditorStaking>
...
deployContract(name: 'CommitteeGovernance', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.CommitteeGovernance>
