...
vi.mock('../../services/auditorRoleActivationService', () => ({ reconcileAuditorStakeForWallet: vi.fn(), suspendAuditorRole: vi.fn() }));
...
vi.mock('../../models/auditorStakeGuardModel', () => ({
  ...
  acquireAuditorUnstakeLock: vi.fn(),
  ...
  releaseAuditorUnstakeLock: vi.fn(),
...
import { resumeAuditorIntent, withdrawAuditorStake } from '../../services/auditorOnboardingService';
