...
vi.mock('../../controllers/projectGovernanceController', () => ({
  ...
  handleGetExecutivePendingPublicationProjectDetail: (_req: any, res: any) => res.sendStatus(200),
  handleGetExecutivePendingPublicationProjects: (_req: any, res: any) => res.sendStatus(200),
