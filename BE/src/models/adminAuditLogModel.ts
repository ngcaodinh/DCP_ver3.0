...
export const ADMIN_AUDIT_ACTIONS = [
  ...
  'AUDITOR_REWARD_PAYOUT_CANCEL_REQUESTED',
  'COMMITTEE_SEAT_CREATED',
  'COMMITTEE_SEAT_SUSPENDED',
  'COMMITTEE_SEATS_BOOTSTRAPPED',
  'DISBURSEMENT_COMMITTEE_VOTE_APPROVE',
  'DISBURSEMENT_COMMITTEE_VOTE_REJECT',
  'DISBURSEMENT_COMMITTEE_EXECUTION_RECOVERED',
  'DISBURSEMENT_COMMITTEE_ON_CHAIN_DECISION_RECOVERED',
  'ARBITRATION_ON_CHAIN_DECISION_RECOVERED'
] as const;
...
const adminAuditLogSchema = new Schema<AdminAuditLogRecord>({
  ...
  targetType: {
    type: String,
    enum: ['DISBURSEMENT_REQUEST', 'OVERRIDE_REQUEST', 'BENEFICIARY_FEEDBACK', 'SBT_MINT_REQUEST', 'AUDITOR_PAYOUT', 'COMMITTEE_SEAT', 'PROJECT_ARBITRATION'],
    index: true
  },
