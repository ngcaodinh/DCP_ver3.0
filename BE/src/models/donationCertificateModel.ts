...
export interface DonationCertificateRecord {
  ...
  lastErrorCode?: string; lastVerificationAt?: Date; reverifyUntilBlock?: number; createdAt: Date; updatedAt: Date;
}
