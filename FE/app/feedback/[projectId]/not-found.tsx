...
/** Hiển thị trang 404 nhẹ riêng cho feedback, không kéo theo canvas của app/not-found.tsx. */
export default function FeedbackNotFound(): React.ReactElement {
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-12">
      <section className="w-full max-w-lg rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        <h1 className="text-2xl font-bold text-slate-900">Dự án không tồn tại</h1>
        <p className="mt-3 text-sm text-slate-600">Vui lòng kiểm tra lại đường dẫn phản hồi.</p>
        <Link
          href="/"
